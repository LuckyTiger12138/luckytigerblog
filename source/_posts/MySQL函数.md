---
title: MySQL函数
date: 2020-06-29 13:21:33
cover: https://jsd.onmicrosoft.cn/gh/LuckyTiger12138/images//img/202311121333521.png
...
 SELECT LOWER('luckytiger'); /*小写*/
 SELECT UPPER('luckytiger'); /*大写*/
...
4.  如果单独对某个用户的密码加密：
    ```sql
     INSERT INTO testmd5 VALUES(3,'luckytiger2','123456')
     update testmd5 set pwd = md5(pwd) where name = 'luckytiger2';
    ```
